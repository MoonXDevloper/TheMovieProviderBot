...
STREAM_API = (environ.get('STREAM_API', '53e2c90c28a466c2508f61cb1baa94aa424894e2'))
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002071135878') # request channel id ( make sure bot is admin )
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/Ultroid_Official/18') # How to open tutorial link for verification
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/AwaraTeams')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Movies4UWorldOfficiall')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/MeAwara') #Support group link ( make sure bot is admin )
...
NO_PORT = bool(environ.get('8080', False))
APP_NAME = None
if 'DYNO' in environ:
    ON_HEROKU = True
